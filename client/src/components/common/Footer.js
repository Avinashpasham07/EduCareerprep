                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-slate-500 dark:text-slate-400 text-sm">
                            ...
                            <li><Link to="/colleges" className="hover:text-primary-600 transition-colors">Colleges</Link></li>
                            <li><Link to="/interviews" className="hover:text-primary-600 transition-colors">AI Interview</Link></li>
                        </ul>
                    </div>
                    <div>
